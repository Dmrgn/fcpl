...
// expects arguments GreaterOrEqualTo(anything, anything);
export class GreaterOrEqualTo {
    static resolve(self, scope) {
        ...
        if (args.length != 2) console.log("hmmm... GreaterOrEqualTo expected 2 arguments but got " + args.length + " instead on line " + line);
